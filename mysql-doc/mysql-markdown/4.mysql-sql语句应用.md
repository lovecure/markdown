...
2.添加普通索引:
  ...
  alter table student add <mark>index 固定语法</mark> index_name(dept列名);
...
create index <mark>index_dept</mark>索引名称 on student(dept<mark>列</mark>(8)<mark>前8个字符创建</mark>);




查看建立的索引:
show create index from student\G;
